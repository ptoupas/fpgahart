...
class CodeFile:
    ...
    def write(self, x, indent=0, newlines=1):
        self.out.write(
            self.indent * (self.current_indent + indent) + x + "\n" * newlines
        )
    ...
    def __call__(self, text, newlines=1):
        self.write(self.format(text), newlines=newlines)
