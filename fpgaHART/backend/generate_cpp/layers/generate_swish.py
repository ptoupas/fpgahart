...
def generate_swish_hpp(name, config, partition_name):
    ...
    hpp(f"#define {layer_name_upper}_SWISH_CHANNELS \tDIVIDE({layer_name_upper}_CHANNELS, {layer_name_upper}_COARSE)")
    ...
    hpp(f"#define {layer_name_upper}_SWISH_WIDTH \t{layer_name_upper}_WIDTH", newlines=2)
...
def generate_swish_files(name, config, partition_name):
    ...
    generate_swish_hpp(name, config, partition_name)
    generate_swish_cpp(name, config, partition_name)