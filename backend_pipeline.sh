...
do
    ...
    cp fpgaHART/backend/run_hls.tcl $HLS_PARENT_DIR/$PARTITION_NAME/$CURRENT_PARTITION/
    
    FPGAHART_PATH=$PWD
    cd $HLS_PARENT_DIR/$PARTITION_NAME/$CURRENT_PARTITION/src
    ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/swish_3d.hpp swish_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/squeeze_3d.hpp squeeze_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/split_3d.hpp split_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/sliding_window_3d.hpp sliding_window_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/sigmoid_3d.hpp sigmoid_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/relu_3d.hpp relu_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/glue_3d.hpp glue_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/gap_3d.hpp gap_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/fork_3d.hpp fork_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/elemwise_3d.hpp elemwise_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/conv_3d.hpp conv_3d_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/common.hpp common_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/common_tb.hpp common_tb_.hpp && ln -nsf $FPGAHART_PATH/fpgaHART/backend/include_files/accum_3d.hpp accum_3d_.hpp
    cd - > /dev/null
done